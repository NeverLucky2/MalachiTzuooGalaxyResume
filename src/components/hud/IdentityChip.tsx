...
export function IdentityChip() {
  return (
    <div data-tour="name" className="pointer-events-none fixed left-[calc(12px+env(safe-area-inset-left))] top-[calc(12px+env(safe-area-inset-top))] z-30 rounded-[14px] border border-[#21e6ff]/50 bg-[#0a0a1f]/60 px-3 py-2 shadow-[0_0_18px_rgba(33,230,255,.35)] backdrop-blur-md">
